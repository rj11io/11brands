...
The `11portfolio` site. This file is candidate `sky700` in the 11portfolio
colour round, which now holds ten light-mode blue variants. None chosen yet.

## Palette decision

Mode light. Signal `#0369A1` on ground `#FAFAFA`: **5.68:1**.

Sky 700. The cyan-leaning blue, and the closest passing relative of the
requested cyan 400.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 5.68:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.34:1 |
| footer grey | `#676767` | 1.05:1 |

Nearest active brand on this ground: `11blog-11cv`, CIEDE2000 **11.3**. Every
...
The candidate to pick if the appeal of cyan 400 is the hue rather than the
brightness: same direction, stepped dark enough to clear the floor at 5.68:1
with a strong 3.34:1 against the ink. dE 11.3 from 11cv.
