...
The `11gw` site. This file is candidate `red700` in the first 11gw colour
round: six light-mode red variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#B91C1C` on ground `#FAFAFA`: **6.20:1**.

Red 700. The deep red: high contrast while still clearly red rather than brown.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 6.20:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.06:1 |
| footer grey | `#676767` | 1.14:1 |

Nearest active brand: `11blog-11labs`, CIEDE2000 **19.9**. Every candidate in this
...
6.20:1. Ink separation drops to 3.06:1 here, the point at which the accent square starts losing its edge against the numeral at small sizes.
