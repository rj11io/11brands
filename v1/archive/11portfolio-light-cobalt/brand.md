...
The `11portfolio` site. This file is candidate `cobalt` in the 11portfolio
colour round, which now holds ten light-mode blue variants. None chosen yet.

## Palette decision

Mode light. Signal `#1552B5` on ground `#FAFAFA`: **6.92:1**.

Cobalt. The saturated true blue: the most conventional reading of the brief.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 6.92:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.74:1 |
| footer grey | `#676767` | 1.28:1 |

Nearest active brand on this ground: `11blog-11cv`, CIEDE2000 **8.9**. Every
...
dE 8.9 from 11cv is the tightest of the nine passing candidates, and the two
share a ground. Comparable to the dE 10.3 that 11archive accepted against
11ai, but tighter — check the pair at 16px before choosing it.
