...
The archive site. This file is candidate `teal` in the first 11archive
...
Teal 700. Teal fills the space between 11ai's deep green and 11bench's cyan, neither of which shares a ground with it.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 5.24:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.62:1 |
...
11ai's `#007A55` is the risk: both are dark blue-greens on the same `#FAFAFA` ground, and they are the closest same-context pair in the round. Teal 700 is cooler and lighter, but this candidate must not be chosen without a 16px comparison against 11ai.
