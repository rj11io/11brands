...
The `11portfolio` site. This file is candidate `blue900` in the 11portfolio
colour round, which now holds ten light-mode blue variants. None chosen yet.

## Palette decision

Mode light. Signal `#1E3A8A` on ground `#FAFAFA`: **9.92:1**.

Blue 900. Navy: the safest separation from 11cv and the highest ground
contrast in the round.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 9.92:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 1.91:1 |
| footer grey | `#676767` | 1.83:1 |

Nearest active brand on this ground: `11blog-11cv`, CIEDE2000 **17.5**. Every
...
dE 17.5 from 11cv, the widest margin here. The trade is the ink: 1.91:1 is the
weakest of the nine passing candidates and near the bottom of the 1.6 to 3.6
band the family's chromatic signals occupy, so the accent square starts
merging into the numeral at 16px.
