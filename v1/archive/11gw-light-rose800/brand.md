...
The `11gw` site. This file is candidate `rose800` in the first 11gw colour
round: six light-mode red variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#9F1239` on ground `#FAFAFA`: **7.68:1**.

Rose 800. The deep pink-leaning option, the counterpart to red 800 at the dark end.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 7.68:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.47:1 |
| footer grey | `#676767` | 1.47:1 |

Nearest active brand: `11blog-11support`, CIEDE2000 **24.9**. Every candidate in this
...
7.68:1 and dE 24.9 from the nearest active brand, the widest separation in the round after red 800. Note the archived `11support-light-rose` (`#BE123C`) is the nearest hue in the whole registry at dE 6.7, retired and therefore free, but worth knowing if 11support is ever revisited.
