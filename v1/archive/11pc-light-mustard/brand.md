...
The `11pc` site. This file is candidate `mustard` in the first 11pc colour
round: six light-mode yellow variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#8A6D0B` on ground `#FAFAFA`: **4.71:1**.

Mustard, yellow 750-ish. The darkest candidate that still reads yellow rather than brown, and the first to clear the 4.5:1 aim.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 4.71:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 4.03:1 |
| footer grey | `#676767` | 1.15:1 |

Nearest active brand: `11blog-11labs`, CIEDE2000 **28.8**. Every candidate in this
...
Clears the aim at 4.71:1, so it can be set in type on this ground if wanted. Best ink separation of the round after amber 600 and brass. Furthest from every active brand at dE 28.8.
