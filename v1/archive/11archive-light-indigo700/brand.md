...
The archive site. This file is candidate `indigo700` in the first 11archive
colour round: ten light-mode variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#4338CA` on ground `#FAFAFA`: **7.57:1**.

Indigo 700. The darker indigo, further from 11cv's blue than indigo 600 is.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 7.57:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.51:1 |
| footer grey | `#676767` | 1.40:1 |
...
Buys separation from 11cv (`#2563EB`) by going darker, at the cost of ink separation (2.51:1). The safer of the two indigos against the family, the weaker against the numeral.
