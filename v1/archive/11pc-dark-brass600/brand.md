...
The `11pc` site. This file is candidate `brass600` in the 11pc **dark-mode**
round: six variants on `#0A0A0A`, none of them chosen yet. A separate
light-mode round of six exists as `11pc-light-*`.

## Palette decision

Mode dark. Signal `#BFA100` on ground `#0A0A0A`: **7.84:1**.

Brass 600. True yellow with no orange lean, the dark-mode counterpart to the light round's brass.
...
| --- | --- | --- |
| ground | `#0A0A0A` | 7.84:1 |
| ink (the numeral beside the square) | `#FAFAFA` | 2.42:1 |
| footer grey | `#A1A1A1` | 1.02:1 |

Nearest brand sharing this ground: `11b2b`, CIEDE2000 **12.1**. Every
...
dE 12.1 from 11b2b, a comfortable margin. Its 1.02:1 against the footer grey is the lowest in the round; that does not bind a chromatic signal, but the accent and the footer text do sit at nearly the same lightness.
