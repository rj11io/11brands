...
The archive site. This file is candidate `violet` in the first 11archive
colour round: ten light-mode variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#6D28D9` on ground `#FAFAFA`: **6.81:1**.

Violet 700. Violet is unused by every active brand: the family has no purple at all.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 6.81:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.79:1 |
| footer grey | `#676767` | 1.26:1 |
...
Nearest is the archived `11brands-light-violet` (`#7C3AED`, violet 600), one step lighter and retired, so the hue is free. No active brand is within reach of it.
