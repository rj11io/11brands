...
The archive site. This file is candidate `olive` in the first 11archive
colour round: ten light-mode variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#4D7C0F` on ground `#FAFAFA`: **4.78:1**.

Lime 700. Yellow-green is completely unused: the family's greens are all emerald or cyan side.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 4.78:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.96:1 |
...
Clearly separable from 11ai's `#007A55`, which is the nearest green. Lowest ground contrast of the round after bronze, still comfortably past the 4.5:1 aim, and the second best ink separation (3.96:1).
