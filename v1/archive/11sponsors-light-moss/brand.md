...
The `11sponsors` site. This file is candidate `moss` in the first 11sponsors
colour round: twelve light-mode variants, six pink and six green, none of them
chosen yet.

## Palette decision

Mode light. Signal `#3F6212` on ground `#FAFAFA`: **6.78:1**.

Moss. Green shifted toward olive, which is where the family's light-ground
green space is emptiest.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 6.78:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.80:1 |
| footer grey | `#676767` | 1.25:1 |

Measured against `11ai`, the brand this half of the round has to clear:
CIEDE2000 **16.5**. Every candidate here is chromatic, so the footer ratio
...
dE 16.5 from 11ai at a comfortable 6.78:1. Nearest anywhere is the archived
`11archive-light-olive` (`#4D7C0F`) at dE 9.3 — retired, so free. The question
is whether it still reads as green rather than as olive.
