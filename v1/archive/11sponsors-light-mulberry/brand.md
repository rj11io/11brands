...
The `11sponsors` site. This file is candidate `mulberry` in the first
11sponsors colour round: twelve light-mode variants, six pink and six green,
none of them chosen yet.

## Palette decision

Mode light. Signal `#A34A78` on ground `#FAFAFA`: **5.28:1**.

Mulberry. A muted, greyed pink: the quietest candidate in the round.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 5.28:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.59:1 |
| footer grey | `#676767` | 1.03:1 |

Measured against `11support`, the brand this half of the round has to clear:
CIEDE2000 **14.7**. Every candidate here is chromatic, so the footer ratio
...
dE 14.7 from 11support. The muting is what separates it visually rather than
the hue, which is a weaker kind of separation at 16px than a hue shift would
be. Its 1.03:1 against the footer grey is the lowest here; that does not bind
a chromatic signal, but accent and footer text sit at nearly the same
lightness.
