...
The `11gw` site. This file is candidate `red800` in the first 11gw colour
round: six light-mode red variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#991B1B` on ground `#FAFAFA`: **7.96:1**.

Red 800. The safest contrast in the round, at the cost of reading as oxblood rather than red.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 7.96:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.38:1 |
| footer grey | `#676767` | 1.47:1 |

Nearest active brand: `11blog-11labs`, CIEDE2000 **25.4**. Every candidate in this
...
7.96:1 on the ground but only 2.38:1 against the ink, the lowest in the round: at 16px this reads as a dark mark with a barely distinct accent. The mirror of the yellow round's yellow 800 problem.
