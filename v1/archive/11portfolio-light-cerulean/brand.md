...
The `11portfolio` site. This file is candidate `cerulean` in the 11portfolio
colour round, which now holds ten light-mode blue variants. None chosen yet.

## Palette decision

Mode light. Signal `#17638F` on ground `#FAFAFA`: **6.25:1**.

Cerulean. A muted, slightly grey-shifted mid blue: the quietest candidate in
the round.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 6.25:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.03:1 |
| footer grey | `#676767` | 1.15:1 |

Nearest active brand on this ground: `11blog-11cv`, CIEDE2000 **12.0**. Every
...
dE 12.0 from 11cv, and dE 3.0 from sky 700 — the two are the closest pair in
this round, separated mostly by saturation rather than hue. Worth seeing side
by side before treating them as distinct options.
