...
The archive site. This file is candidate `plum` in the first 11archive
colour round: ten light-mode variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#6B21A8` on ground `#FAFAFA`: **8.35:1**.

Purple 800. The darkest purple in the round, and the second highest contrast of the ten.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 8.35:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.27:1 |
...
One step darker than the purple 700 candidate. At 8.35:1 it reads almost as ink at a glance, which is the trade: very safe on the ground, least separable from the numeral (2.27:1 against the ink, the lowest in the round).
