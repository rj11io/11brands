...
The `11pc` site. This file is candidate `yellow600` in the 11pc **dark-mode**
round: six variants on `#0A0A0A`, none of them chosen yet. A separate
light-mode round of six exists as `11pc-light-*`.

## Palette decision

Mode dark. Signal `#CA8A04` on ground `#0A0A0A`: **6.74:1**.

Yellow 600. The deepest yellow in the round, and the best ink separation because of it.
...
| --- | --- | --- |
| ground | `#0A0A0A` | 6.74:1 |
| ink (the numeral beside the square) | `#FAFAFA` | 2.81:1 |
| footer grey | `#A1A1A1` | 1.14:1 |

Nearest brand sharing this ground: `11b2b`, CIEDE2000 **15.0**. Every
...
2.81:1 against the ink is the strongest in the round, so the accent square holds its shape at 16px better than any other candidate here. Lowest ground contrast at 6.74:1, which on a dark ground is still ample.
