...
The `11pc` site. This file is candidate `amber700` in the first 11pc colour
round: six light-mode yellow variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#B45309` on ground `#FAFAFA`: **4.81:1**.

Amber 700. The orange-leaning counterpart to mustard: same contrast band, warmer hue.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 4.81:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.94:1 |
| footer grey | `#676767` | 1.13:1 |
...
Clears the aim at 4.81:1. Tied with amber 600 as the closest candidate to 11labs' orange 600 (dE 11.6) — the two ambers are this round's family-collision risk, and both should be seen next to a 11labs card at 16px before being chosen.
