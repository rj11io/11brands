...
The `11pc` site. This file is candidate `olive500` in the 11pc **dark-mode**
round: six variants on `#0A0A0A`, none of them chosen yet. A separate
light-mode round of six exists as `11pc-light-*`.

## Palette decision

Mode dark. Signal `#9CAF00` on ground `#0A0A0A`: **8.06:1**.

Olive 500. The most green-shifted candidate: furthest from 11b2b, and the point at which yellow starts becoming lime.
...
| --- | --- | --- |
| ground | `#0A0A0A` | 8.06:1 |
| ink (the numeral beside the square) | `#FAFAFA` | 2.35:1 |
| footer grey | `#A1A1A1` | 1.05:1 |

Nearest brand sharing this ground: `11b2b`, CIEDE2000 **21.6**. Every
...
dE 21.6 from 11b2b, the widest separation in the round, with a healthy 2.35:1 against the ink. The question is whether it still reads as the yellow brand that was asked for. Next-nearest family colour is 11blog's emerald, still far off.
