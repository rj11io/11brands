...
The archive site. This file is candidate `bronze` in the first 11archive
colour round: ten light-mode variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#A16207` on ground `#FAFAFA`: **4.72:1**.

Yellow 700. Dark gold, the warm counterpart to sepia and the only candidate that keeps real brightness while staying past the 4.5:1 aim.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 4.72:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 4.02:1 |
...
11b2b carries amber 400 (`#FBBF24`) but only on a dark ground, so the two never share a context. Lowest ground contrast of the round at 4.72:1 and the best ink separation at 4.02:1, which is the inverse trade to sepia and plum.
