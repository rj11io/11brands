...
The `11gw` site. This file is candidate `red600` in the first 11gw colour
round: six light-mode red variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#DC2626` on ground `#FAFAFA`: **4.63:1**.

Red 600. The canonical red, and the reference point the other five are judged against.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 4.63:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 4.10:1 |
| footer grey | `#676767` | 1.17:1 |

Nearest active brand: `11blog-11labs`, CIEDE2000 **14.4**. Every candidate in this
...
Clears the aim with a little headroom. Closest candidate in the round to an active brand (11labs' orange 600 at dE 14.4), which is still a wide margin — over the whole round nothing comes near the dE 10.3 that 11archive accepted against 11ai.
