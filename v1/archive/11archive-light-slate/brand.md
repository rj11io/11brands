...
The archive site. This file is candidate `slate` in the first 11archive
colour round: ten light-mode variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#475569` on ground `#FAFAFA`: **7.26:1**.

Slate 600. A cool neutral, the light-mode counterpart to 11cc's silver on dark. Thematically the quietest option for an archive.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 7.26:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.61:1 |
| footer grey | `#676767` | 1.34:1 |
...
**A neutral signal needs three checks, and this one fails the third.** Ground 7.26:1 passes and ink 2.61:1 is workable, but against the footer grey `#676767` it is only 1.34:1 — the accent square and de-emphasised footer text sit at nearly the same lightness, and slate has no hue to pull them apart. The other nine are chromatic, so the footer number does not bind them; it binds this one. Choosing slate means accepting that the square reads as a third grey, or moving the footer colour.
