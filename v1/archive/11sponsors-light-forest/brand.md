...
The `11sponsors` site. This file is candidate `forest` in the first 11sponsors
colour round: twelve light-mode variants, six pink and six green, none of them
chosen yet.

## Palette decision

Mode light. Signal `#14532D` on ground `#FAFAFA`: **8.73:1**.

Forest. The deepest green: highest contrast in this round, at the cost of
reading almost as black.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 8.73:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.17:1 |
| footer grey | `#676767` | 1.61:1 |

Measured against `11ai`, the brand this half of the round has to clear:
CIEDE2000 **13.3**. Every candidate here is chromatic, so the footer ratio
...
8.73:1 on the ground but only 2.17:1 against the ink, the weakest here. At
16px the accent square barely separates from the numeral. The same trade the
deep end of every round in this project has made.
