...
The `11gw` site. This file is candidate `terracotta` in the 11gw **dark-mode**
round: six variants on `#0A0A0A`, none of them chosen yet. A separate
light-mode round of six exists as `11gw-light-*`.

## Palette decision

Mode dark. Signal `#E77E63` on ground `#0A0A0A`: **7.13:1**.

Terracotta. The warm, earthy option: red shifted toward orange-brown rather than toward pink.
...
| --- | --- | --- |
| ground | `#0A0A0A` | 7.13:1 |
| ink (the numeral beside the square) | `#FAFAFA` | 2.66:1 |
| footer grey | `#A1A1A1` | 1.07:1 |

Nearest brand sharing this ground: `11blog-11intel`, CIEDE2000 **12.0**. Every
...
dE 12.0 from 11intel. The one to watch is 11io's orange `#F97316`, which is the other warm dark brand; terracotta is muted and browner, but the two are the warmest pair in the family.
