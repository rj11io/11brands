...
The `11pc` site. This file is candidate `yellow800` in the first 11pc colour
round: six light-mode yellow variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#854D0E` on ground `#FAFAFA`: **6.56:1**.

Yellow 800. The safest contrast in the round by a wide margin.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 6.56:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 2.89:1 |
| footer grey | `#676767` | 1.21:1 |

Nearest active brand: `11blog-11labs`, CIEDE2000 **22.9**. Every candidate in this
...
At 6.56:1 it is unambiguously safe on the ground, and the trade is honest: this reads as dark brown, not as yellow. Lowest ink separation of the six at 2.89:1, so at 16px the accent square and the numeral start to merge. Pick this only if contrast outranks the brief.
