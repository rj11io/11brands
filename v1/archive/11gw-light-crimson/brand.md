...
The `11gw` site. This file is candidate `crimson` in the first 11gw colour
round: six light-mode red variants, none of them chosen yet.

## Palette decision

Mode light. Signal `#C81E1E` on ground `#FAFAFA`: **5.50:1**.

Crimson. A deeper, purer red than red 600, with noticeably more contrast for very little loss of brightness.
...
| --- | --- | --- |
| ground | `#FAFAFA` | 5.50:1 |
| ink (the numeral beside the square) | `#0A0A0A` | 3.45:1 |
| footer grey | `#676767` | 1.01:1 |

Nearest active brand: `11blog-11labs`, CIEDE2000 **17.3**. Every candidate in this
...
5.50:1 with good hue separation from both warm neighbours. Its footer ratio of 1.01:1 is the lowest in the round, which does not bind a chromatic signal but does mean the accent and the footer text sit at almost exactly the same lightness.
