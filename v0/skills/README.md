...
| Skill | Use it for |
| --- | --- |
| [`11brands-v0-init-brand/`](11brands-v0-init-brand/) | Drafting a new brand and choosing its signal colour |
| [`11brands-v0-generate-assets/`](11brands-v0-generate-assets/) | Generating favicons and website or content Open Graph cards |
| [`11brands-v0-verify-assets/`](11brands-v0-verify-assets/) | Measuring output changes and checking colour gamut |
| [`11brands-v0-promote-draft/`](11brands-v0-promote-draft/) | Moving an approved draft into the registered set |
